...
export const toyStoryLandGuide = [
  ...
  { id: 'alien-saucers', name: 'Alien Swirling Saucers', emoji: '👽', description: "Whip-style spinning ride themed to the Little Green Men. Gentle enough for younger kids (32\" req). The neon lighting and Toy Story music make it a blast.", tip: 'Usually shorter waits in the afternoon. Both Luna and Clara can ride!' },
...
export const thrillGuide = [
  { id: 'tower', name: 'Tower of Terror — Drop Sequences', emoji: '🗼', description: "The Hollywood Tower Hotel uses a randomized drop sequence — each ride is different! Sometimes you get 2 drops, sometimes 4+. The moment of weightlessness at the top, with the doors opening to reveal the park, is unforgettable. 40\" height req.", tip: 'Front row has the best view when doors open. Luna can ride if she hits 40\"!' },
  { id: 'rock-n-roller', name: "Rock 'n' Roller Coaster", emoji: '🎸', description: "High-speed launch coaster that goes 0-57 mph in 2.8 seconds, with 3 inversions in the dark, all set to Aerosmith's greatest hits. The only Disney World coaster with inversions. 48\" req — adults only for our group.", tip: 'Use Rider Swap so both parents can ride. Single rider line is also fast.' },
  { id: 'rider-swap-strategy', name: 'Rider Swap Strategy', emoji: '🔄', description: "For rides the kids can't do, use Disney's Rider Swap. Parent A rides while Parent B waits with kids. Then Parent B gets to ride with up to 2 others without waiting again! Works for Tower, Rock 'n' Roller Coaster, and Rise of the Resistance.", tip: 'Ask a Cast Member at the ride entrance to set up Rider Swap before joining the line.' },
];

export const hsStrategy = {
  morning: [
    { time: '6:30 AM', step: 'Wake up and head to bus/Minnie Van' },
    { time: '7:15 AM', step: 'Arrive at HS, through bag check' },
    { time: '7:30 AM', step: "Early Entry: Head straight to Rise of the Resistance" },
    { time: '8:00 AM', step: "After Rise: Slinky Dog Dash or Tower of Terror" },
    { time: '8:30 AM', step: "Official opening — head to Galaxy's Edge for Smuggler's Run" },
