...
export const toyStoryLandGuide = [
  ...
  { id: 'alien-saucers', name: 'Alien Swirling Saucers', emoji: '👽', description: "Whip-style spinning ride themed to the Little Green Men. Gentle enough for younger kids (32\" req). The neon lighting and Toy Story music make it a blast.", tip: 'Usually shorter waits in the afternoon. No height requirement — great for little ones!' },
