...
export const mkStrategy = {
  morning: [
    ...
    { time: '7:45 AM', step: 'Early Entry begins — head straight to Seven Dwarfs Mine Train' },
    { time: '8:00 AM', step: "After Mine Train: Peter Pan's Flight, then Haunted Mansion" },
    { time: '8:30 AM', step: "Official park opening. Hit Big Thunder Mountain or Tiana's Bayou" },
  ],
  afternoon: [
    { time: '11:30 AM', step: 'Mobile order lunch at Cosmic Ray\'s or Pecos Bill' },
    { time: '12:00 PM', step: 'Catch the Festival of Fantasy parade from Frontierland' },
    { time: '1:00 PM', step: 'Use Lightning Lane for Space Mountain or TRON' },
    { time: '2:00 PM', step: 'Cool off at indoor rides: PhilharMagic, Laugh Floor, Carousel of Progress' },
