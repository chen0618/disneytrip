...
export const mapRides = [
  ...
  // Frontierland
  {
    ...
    lat: 28.4203061,
    lng: -81.5847249,
    description: 'Runaway mine train coaster through the desert — reopened May 2026 with all-new trains, refreshed audio-animatronics, and a stunning enhanced Rainbow Caverns scene featuring glowing pools and shimmering stalagmites.',
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Peter_Pan%27s_Flight_at_Magic_Kingdom.jpg/960px-Peter_Pan%27s_Flight_at_Magic_Kingdom.jpg',
    heightReq: null,
    heightReqInches: 0,
    lightningLane: true,
  ...
  },
  {
    ...
    lat: 28.4180156,
    lng: -81.5797768,
    description: 'Interactive shooting ride recharged in April 2026 — handheld blasters with always-on laser sights, new ride vehicles with scoring monitors, reactive light-up targets, and a new opening scene starring "Buddy" the support-bot.',
    firstTimerTip: 'The recharged version has handheld blasters (not fixed guns!) with two colors per vehicle so you can tell whose score is whose. New targets light up when hit — much more satisfying than the old version.',
  ...
  },
  {
    ...
    name: 'Millennium Falcon: Smugglers Run — A New Mission',
    emoji: '🛸',
    type: 'ride',
    park: 'Hollywood Studios',
    land: "Galaxy's Edge",
    lat: 28.35352,
    lng: -81.56170,
    description: 'Fly the Falcon with Din Djarin & Grogu! Pick your destination — Bespin, Endor, or Coruscant. Full Mandalorian overlay since May 2026.',
